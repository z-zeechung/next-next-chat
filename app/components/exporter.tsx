...
//   messages: Message[];
//   onRender: (messages: Message[]) => void;
// }) {
...
//       return new MarkdownMessage(role as any, role === "user" ? v.textContent ?? "" : v.innerHTML)
//       // {
//       //   id: i.toString(),
//       //   role: role as any,
...
//         >
//           <Markdown content={/*getMessageTextContent(m)*/m.content} defaultShow />
//         </div>
//       ))}
//     </div>
//   );
...
//   const onRenderMsgs = (msgs: Message[]) => {
...
//                 <Markdown
//                   content={/*getMessageTextContent(m)*/m.content}
...
//       .map((m) => {
//         return m.role === "user"
//           ? `## ${Locale.Export.MessageFromYou}:\n${/*getMessageTextContent(m)*/m.content}`
